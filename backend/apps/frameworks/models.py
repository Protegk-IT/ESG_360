...
class FrameworkVersion(BaseModel):
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(
                ...
                name="ck_fw_version_effective_date_range",
            ),
            models.CheckConstraint(
                condition=(
                    models.Q(published_at__isnull=True)
                    | models.Q(effective_from__isnull=True)
                    | models.Q(published_at__lte=models.F("effective_from"))
                ),
                name="ck_fw_version_publication_date",
            ),
            models.CheckConstraint(
                condition=(
                ...
                name="ck_fw_version_default_active",
            ),
    ...
    def clean(self):
        ...
        if (
            ...
            and self.published_at > self.effective_from
        ):
            errors["published_at"] = (
