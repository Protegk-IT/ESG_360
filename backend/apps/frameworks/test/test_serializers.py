...
class FrameworkVersionSerializerTests(TestCase):
    ...
    def test_invalid_effective_date_range_returns_effective_to_error(self):
        serializer = FrameworkVersionSerializer(
            data={
    ...
    def test_invalid_publication_date_returns_published_at_error(self):
        serializer = FrameworkVersionSerializer(
            data={
                "framework": str(self.framework.id),
                "version_code": "2021",
    ...
    def test_default_inactive_returns_is_default_error(self):
        serializer = FrameworkVersionSerializer(
            data={
                "framework": str(self.framework.id),
                "version_code": "2021",
    ...
    def test_missing_framework_returns_framework_error(self):
        serializer = FrameworkVersionSerializer(
            data={
                "version_code": "2021",
            }
        ...
        self.assertFalse(serializer.is_valid())
        self.assertIn("framework", serializer.errors)

    def test_patch_with_omitted_dates_uses_instance_values(self):
        version = FrameworkVersion.objects.create(
            framework=self.framework,
            version_code="2021",
