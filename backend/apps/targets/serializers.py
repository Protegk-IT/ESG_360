...
class GoalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Goal
        fields = ("id", "name", "description", "material_topic", "material_topic_name", "material_subtopic", "material_subtopic_name", "source_assessment_topic", "source_assessment_topic_name", "source_assessment_id", "source_assessment_topic_topic", "source_assessment_topic_subtopic", "owner", "owner_name", "status", "created_by", "kpi_count", "created_at", "updated_at")
...
class InitiativeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = KPIInitiative
        fields = ("id", "kpi", "kpi_name", "name", "description", "org_node", "org_node_name", "owner", "owner_name", "status", "due_date", "anticipated_impact", "created_at", "updated_at")
