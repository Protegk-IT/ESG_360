...
export default function GoalDetail() {
  ...
  async function saveInitiative() {
    ...
    try {
      ...
      await loadTarget(); setInitiativesOpen(false); toast.success(editingInitiative ? "Initiative updated" : "Initiative added");
  ...
  return <AppShell title={goal?.name ?? "Goal"} description="KPI target planning and approved-data progress.">
    ...
    <InitiativesDialog open={initiativesOpen} onOpenChange={setInitiativesOpen} kpi={selectedKpi} initiatives={initiatives} users={users} orgNodes={orgNodes} editing={editingInitiative} form={initiativeForm} saving={saving} onEdit={openInitiative} onChange={setInitiativeForm} onSave={() => void saveInitiative()} />
  </AppShell>;
}
